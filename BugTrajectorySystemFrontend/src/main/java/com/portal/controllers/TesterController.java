...
BugAllocationService bugAllocationDetailService;
                ...
                @RequestMapping(value="/projectAllocated/{projId}",method=RequestMethod.GET)
                public ModelAndView getBugReport(@PathVariable("projId")String projId,@RequestParam(name="msg",required=false)String msg) {
                ...
                public String getBugAllocationDetails(@RequestParam String bug,@RequestParam String severity,@RequestParam String description)
                {
                                ...
                                bugObj.setP_Id(pObj.getProject_Id());
                                System.out.println(bugObj);
                                
                                bugAllocationDetailService.saveBugDetails(bugObj);
                                return "redirect:projectAllocated/"+pObj.getProject_Id()+"?msg='successfully allocated";
